# 汇报复盘 Pattern Examples And Acceptance
...
- Primary task: 周期结果/原因摘要/后续行动.
- Common component bundle: 结论摘要、阶段结果、变化原因、风险问题、行动计划.
- Acceptance focus: 复盘周期、版本、证据来源、行动负责人和截止时间.
