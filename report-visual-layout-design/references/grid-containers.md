...
| 饼图 / 雷达图 / 旭日图 / 仪表盘 | `1*1`, `2*2`, `3*2`, `2*3`, `3*3`, `4*4` |
| 散点图 / 盒须图 | `3*1`, `2*2`, `3*2`, `2*3`, `3*3`, `2*4`, `4*4`, `4*2`, `4*3`, `3*4` |
| 平行坐标系 | `3*2`, `3*3`, `4*2`, `4*3`, `3*4`, `4*4` |
| 地图 / 路径图 / 关系图 / 树图 / 矩形树图 / 漏斗图 | `2*2`, `3*2`, `3*3`, `4*3`, `4*4` |
| 桑基图 | `3*2`, `3*3`, `4*3`, `4*4` |
| 指标卡 | `1*1`, `2*1` |
