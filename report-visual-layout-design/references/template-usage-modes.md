...
- Edit `src/config/dashboard.config.ts` for title, theme, navigation, `layoutRows`, `widgets`, global filters, and toolbar labels.
- Put mock/static data in `src/data/dashboard.dataset.json`.
