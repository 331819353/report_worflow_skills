...
- Passing the outer `8 * N` block grid is not enough. Composite widgets, summary areas, nested KPI grids, comparison tiles, and custom small cards must pass their own internal fit check inside the real component viewport.
