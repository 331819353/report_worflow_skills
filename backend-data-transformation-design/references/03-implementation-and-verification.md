...
- Compare representative runtime responses through `$backend-api-contract-validation` when implementation exists.
- Record unknown rules or temporary defaults in `$backend-missing-info-management`.
