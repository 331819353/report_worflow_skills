...
- The shared card base is owned by the template: dark cockpit theme uses black-blue cards, 8px radius, 24px padding, light controlled shadow, and no hard border; light theme uses white cards with the same geometry.
