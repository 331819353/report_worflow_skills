...
- SVG/canvas/ECharts custom graphics, gauges, maps, radars, pies, paths, and complex diagrams preserve aspect ratio and geometry; warped curves, stretched maps, oval circles/radars, or squeezed gauges fail visual QA.
