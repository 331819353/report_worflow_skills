...
- Page layout owns page shell identity and block placement, while each block owns its own title/function/local-filter area. Component bodies do not duplicate visible block-owned titles through chart/table/KPI internal title options.
