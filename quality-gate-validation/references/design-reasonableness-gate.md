...
- Fixed-height navigation/cards/KPI tiles have a declared height budget and DOM overflow evidence; `scrollHeight > clientHeight` or `scrollWidth > clientWidth` blocks ready status unless the overflow region is intentional and visibly scrollable.
